...
urlpatterns = [
    ...
    url(r'^chapters/(?P<chapter_id>[0-9]+)/add-words$', views.chapter_add_words,
        name='dictionaries-chapters-add-words'),

    url(r'^learn/$', views.learn_index, name='learn'),
    url(r'^learn/(?P<selected_word_id>[0-9]+)/$', views.learn_word, name='learn-word'),
    url(r'^learn/(?P<selected_word_id>[0-9]+)/translation/$', views.learn_word_with_translation,
        name='learn-word-with-translation'),
